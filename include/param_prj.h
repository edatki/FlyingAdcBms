...
//Select which set of hardware specific params to include
#ifdef HW_MAX17841B
#define PARAM_LIST_HW_SPECIFIC PARAM_LIST_MAX_BMS
#else
#define PARAM_LIST_HW_SPECIFIC PARAM_LIST_FLYING_ADC_BMS
#endif
